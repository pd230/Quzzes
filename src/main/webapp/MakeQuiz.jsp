...
<form>
    <label class="mb-2 text-bold" title="label">Select Language:</label>
    <input type="radio" name="lang"> JAVA
    <input type="radio" name="lang"> PYTHON<br><br>
    
    <label class="mb-2" title="time">Select Time:</label>
    ...
    <label class="mb-2" title="level">Select Quizz level:</label>
